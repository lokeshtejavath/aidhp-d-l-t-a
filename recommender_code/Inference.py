...
df_pivot_loan = pd.read_csv("pivot_loan_info.csv")
df_pivot_loan = pd.get_dummies(df_pivot_loan, columns=['Gender','Marital_Status','Dependents','Education','Employment_Status','Occupation_Type','Residential_Status'], dtype='float32')
